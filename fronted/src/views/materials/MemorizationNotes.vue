<template>
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-8">
      <div class="flex items-center space-x-4">
        <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div>
          <h1 class="text-3xl font-bold text-gray-900">背诵笔记</h1>
          <p class="text-gray-600">重点内容、公式记忆、知识点背诵</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        <div v-for="note in recommendedNotes" :key="note.id"
             ...
             class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-green-400 hover:shadow-lg cursor-pointer transition-all">
    ...
    <div @click="showNotesList = true"
         class="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8 hover:shadow-lg cursor-pointer transition-all text-center">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500">{{ memorizationNotes.length }} 条笔记</p>
                </div>
              </div>
              <button 
              ...
              <div class="bg-green-50 rounded-xl p-4 mb-4">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <span class="text-lg font-bold text-green-600 ml-2">已巩固 {{ selectedNote.reviewCount || 0 }} 次</span>
                  </div>
...
const recommendedNotes = ref<MemorizationNote[]>([])
...
const loadRecommendedNotes = async () => {
  try {
    const response = await getRecommendedNotes('memorization')
